...
module Spider
  ...
  autoload :BailingkeParser,           		File.join(File.dirname(__FILE__), "parser", "bailingke_parser")
  autoload :UbaoParser,           		File.join(File.dirname(__FILE__), "parser", "ubao_parser")
  autoload :OnecarParser,           		File.join(File.dirname(__FILE__), "parser", "onecar_parser")
  autoload :GuguwangParser,           		File.join(File.dirname(__FILE__), "parser", "guguwang_parser")
end
